...
public class NotificacionPush implements CanalNotificacion {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(NotificacionPush.class);
    ...
    public boolean enviar(String destinatario, String mensaje) {
        ...
        // Pendiente: integrar con un proveedor real de push (p.ej. Firebase Cloud Messaging)
        LOGGER.info("Enviando PUSH a {}: {}", destinatario, mensaje);
        return true;
    }
}